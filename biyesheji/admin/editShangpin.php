...
<body>
<h3>添加商品</h3>
<form action="doAdminAction.php?act=editShangpin&id=<?php echo $id;?>" method="post" enctype="multipart/form-data">
<table width="70%"  border="1" cellpadding="5" cellspacing="0" bgcolor="#cccccc">
	...
	<tr>
		...
		<td>
			<input type="radio" name="status"  value="是" />是<input type="radio" name="status"  value="否" />否
		</td>
	</tr>
	<tr>
		<td align="right">时间</td>
		<td>
			<input type="date" name="time" value="<?php echo $proInfo['time'];?>"/>
		</td>
	</tr>
	<tr>
