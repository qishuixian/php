...
<body>
<h3>添加首页焦点图</h3>
<form action="doAdminAction.php?act=editJdtuku&id=<?php echo $id;?>" method="post" enctype="multipart/form-data">
<table width="70%"  border="1" cellpadding="5" cellspacing="0" bgcolor="#cccccc">
	...
	<tr>
        ...
        <tr>
                ...
                <td><input type="text" name="href" placeholder="<?php echo $proInfo['href'];?>"/></td>
        </tr>
	<tr>
