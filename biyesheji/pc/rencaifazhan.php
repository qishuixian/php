...
if($as){
 header("location:../mobile/rencaifazhan.php");
}
?>
<?php include("top.php");?>
<div class="gonsi_3">
	<div class="gonsi_3_left">
        ...
        <ul>
             ...
             <li  id="gs_4" class='gs_li gs_li1'><a href="rencaifazhan.php"><img src="images/gonsi_2.gif" />发展空间</a></li>
        </ul>
    </div>
    <div class="gonsi_3_right">
     	<div class="gonsi3_right">
        	<span class="gonsi3_right1">发展空间</span>
            <span class="gonsi3_right2">您当前的位置：<a href="index.html">首页</a>>><a href="rencaifazhan.php">发展空间</a></span>
        </div>
        <div class="gonsi3_right3">
           <?php 
                require_once '../include.php';
                $sql=mysql_query("select * from rencaifazhan");
                $rencaifazhan=mysql_fetch_array($sql);
                if($rencaifazhan){
                  do{
              ?>
              <p>
                  <?php echo $rencaifazhan['content'];?>
              </p>
              <?php
                  }while($rencaifazhan=mysql_fetch_array($sql));
                  }else{
                  ?>
                    <h3>对不起，没有相关信息</h3>
                  <?php
