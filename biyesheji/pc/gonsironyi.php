...
if($as){
 header("location:../mobile/gonsironyu.php");
}
?>
    <?php include("top.php");?>
<!-- 公司简介的页面的第三部分 -->
<div class="gonsi_3">
	<div class="gonsi_3_left">
        ...
        <ul>
             ...
             <li  id="gs_3" class='gs_li gs_li1' ><a href="gonsironyi.php"><img src="images/gonsi_2.gif" />公司荣誉</a></li>
    ...
    <div class="gonsi_3_right">
     	<div class="gonsi3_right">
        	<span class="gonsi3_right1">公司荣誉</span>
            <span class="gonsi3_right2">您当前的位置：<a href="index.php">首页</a>>><a href="gonsi.php">公司简介</a>>><a href="gonsironyi.php">公司荣誉</a></span>
        </div>
        <div class="gonsi3_right3">
        	<?php 
                require_once '../include.php';
                $sql=mysql_query("select * from gonsironyi");
                $gonsironyi=mysql_fetch_array($sql);
                if($gonsironyi){
                  do{
              ?>
              <p>
                  <?php echo $gonsironyi['content'];?>
              </p>
              <?php
                  }while($gonsironyi=mysql_fetch_array($sql));
                  }else{
                  ?>
                    <h3>对不起，没有相关信息</h3>
                  <?php
