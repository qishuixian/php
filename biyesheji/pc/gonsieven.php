...
<body>
    ...
    if($as){
   header("location:../mobile/gonsieven.php"); 
  }
  ?>
    <?php session_start();?>
    <?php include("top.php");?>
...
<div class="gonsi_3">
	<div class="gonsi_3_left">
        ...
        <ul>
             ...
             <li  id="gs_6" class='gs_li gs_li1'><a href="gonsieven.php"><img src="images/gonsi_2.gif"   />公司事记</a></li>
        </ul>
    </div>
    <div class="gonsi_3_right">
     	<div class="gonsi3_right">
        	<span class="gonsi3_right1">公司事记</span>
            <span class="gonsi3_right2">您当前的位置：<a href="index.php">首页</a>>><a href="gonsieven.php">公司事记</a></span>
        </div>
        <div class="gonsi3_right3">
        	 <?php 
                require_once '../include.php';
                $sql=mysql_query("select * from gonsieven");
                $gonsieven=mysql_fetch_array($sql);
                if($gonsieven){
                  do{
              ?>
              <p>
                  <?php echo $gonsieven['content'];?>
              </p>
              <?php
                  }while($gonsieven=mysql_fetch_array($sql));
                  }else{
                  ?>
                    <h3>对不起，没有相关信息</h3>
                  <?php
