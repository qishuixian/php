...
if($as){
 header("location:../mobile/gonsijianjie.php");
}
?>
    <?php include("top.php");?>
<!-- 公司简介的页面的第三部分 -->
<div class="gonsi_3">
	<div class="gonsi_3_left">
        ...
        <ul>
        	 <li  id="gs_1" class='gs_li gs_li1 ' ><a href="gonsi.php"><img src="images/gonsi_2.gif" />公司概况</a></li>
    ...
    <div class="gonsi_3_right">
     	<div class="gonsi3_right">
            ...
            <span class="gonsi3_right2">您当前的位置：<a href="index.php">首页</a>>><a href="gonsi.php">公司概况</a></span>
        </div>
