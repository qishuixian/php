...
<html lang="zh-CN">
  ...
  if(!$as){
 header("location:../pc/gonsishunnan.php"); 
}
?>
<?php include("top.php");?>
       ...
       <!-- 公司简介  -->
        <section class="mod-box">
	        <div class="row mod-hd bdr">
	          <h3 class="col-xs-10 mod-title">行业新闻</h3>
	        </div>
          ...
          <ul>
              ...
              ?>
                <?php  foreach($rows as $gongao):?>
                  <li class="gonsi-list clearfix">
                      <a href="gonsishunnanDetails.php?id=<?php echo $gongao['id'];?>" class="clearfix" title="<?php echo $gongao['title'];?>" target="_blank">
                          <span class="gonsi-list-a fl"><?php echo $gongao['title'];?></span>
                      
                          <span class="gonsi-list-time fr"><?php echo $gongao['time'];?></span>
                        </a>
                  </li>
              <?php endforeach;?>
            </ul>
