...
<title>车型：车型展示名称__主要车型_这里是您的网站名称</title>
<meta name="keywords" content="车型：车型展示名称_主要车型" />
...
<script language="JavaScript" type="text/javascript" src="/cartshop/Public/pc/style/validForm/FormValid.js"></script>
<script language="JavaScript" type="text/javascript" src="/cartshop/Public/pc/style/jbox/jquery.jBox-2.3.min.js"></script>
...
<div class="fy" style=" background:url(http://0001543.ks.panguweb.cn/upfile/ads/20150804113438-369103644.jpg) center top no-repeat;">
      ...
      <div class="l_pro_t"><?php echo ($topname); ?></div>
        <ul class="l_procon">
          ...
          <?php foreach($son2 as $k=>$v): $cateid=$v['id']; if($contro){ $url="/cartshop/index.php/Home/carlist/index/cateid/$cateid"; }else{ $url="/cartshop/index.php/Home/Article/index/cateid/$cateid"; } ?>
          ...
          <li class="proOne"><a title="<?php echo $v['name'];?>" href="<?php echo $url;?>"><?php echo $v['name'];?></a>
            ...
            <li><a style="padding-left:50px;" title="<?php echo $v1['name'];?>" href="/cartshop/index.php/Home/Article/index/cateid/<?php echo $v1['id'];?>"><?php echo $v1['name'];?></a></li>
              <?php endforeach;?>
          <?php endif;?>
            </ul>
...
邮箱：<?php echo (C("EMAIL")); ?> </div>
        ...
        <div class="fyRight">
        		 <div class="aaleft" >
						<div class="aaleft_kk" id="fix">
									<a class="fy-left" href="<?php echo ($furl); ?>" >上<br />一<br />页</a>						</div>
                   </div>  
                  
                <div class="aaleft1" >
            
						<div class="aaleft_kk" id="fix1">
                        
									<a class="fy-right" href="<?php echo ($aurl); ?>" title="车型：车型展示名称">下<br />一<br />页</a>						</div>
                   </div>
      			<div class="title"> <span class="fl"> 主要车型</span> <span class="fr">当前位置：<a href="/cartshop/index.php" title="首页">首页</a> > 
      			<?php if(is_array($pres)): $i = 0; $__LIST__ = $pres;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i; if($i != count($pres)): ?><a href="/cartshop/index.php/Home/<?php if($vo['type'] == 1): ?>Arlist<?php elseif($vo['type'] == 2): ?>Page<?php elseif($vo['type'] == 3): ?>Message<?php elseif($vo['type'] == 4): ?>Zplist<?php elseif($vo['type'] == 5): ?>Carlist<?php elseif($vo['type'] == 6): ?>Ry<?php elseif($vo['type'] == 7): ?>Job<?php endif; ?>/index/cateid/<?php echo ($vo["id"]); ?>"><?php echo ($vo["name"]); ?></a> &gt;
      			<?php else: ?>
      			<font><?php echo ($vo["name"]); ?></font><?php endif; endforeach; endif; else: echo "" ;endif; ?>
      			</span></div>
				<div class="padding25">
                    <h2 class="center">车型：<?php echo ($articles["title"]); ?></h2>
                    <p class="title_s">文章作者：<?php echo ($articles["author"]); ?>&nbsp;&nbsp;&nbsp;&nbsp;时间：<?php echo (date("Y-m-d",$articles["time"])); ?></p>
                                        <p class="center"><img src="/cartshop/<?php echo ($articles["pic"]); ?>" alt="车型：车型展示名称" /></p>
                                        <p class="pro-ri">
                                        <?php if($aricles['rizu'] != '' ): ?>日租：<?php echo ($articles["rizu"]); ?>元/天<?php endif; ?>
                                        </p>
                     <p class="pro_cname"><span>详细介绍</span></p>
                    <div class="newsview">
                    ...
                    <a href="http://0001543.ks.panguweb.cn/case.php" class="returnlist" title="返回列表">返回列表</a> </div>
