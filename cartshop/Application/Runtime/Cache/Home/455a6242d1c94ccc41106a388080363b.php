...
<script language="JavaScript" type="text/javascript" src="/cartshop/Public/pc/style/ajax.js"></script>
...
<div class="fy" style=" background:url(http://0001543.ks.panguweb.cn/upfile/ads/20150804113438-369103644.jpg) center top no-repeat;">
      ...
      <div class="l_pro_t"><?php echo ($topname); ?></div>
        <ul class="l_procon">
          ...
          <?php foreach($son2 as $k=>$v): $cateid=$v['id']; if($contro){ $url="/cartshop/index.php/Home/carlist/index/cateid/$cateid"; }else{ $url="/cartshop/index.php/Home/Message/index/cateid/$cateid"; } ?>
          ...
          <li class="proOne"><a title="<?php echo $v['name'];?>" href="<?php echo $url;?>"><?php echo $v['name'];?></a>
            ...
            <li><a style="padding-left:50px;" title="<?php echo $v1['name'];?>" href="/cartshop/index.php/Home/Message/index/cateid/<?php echo $v1['id'];?>"><?php echo $v1['name'];?></a></li>
              <?php endforeach;?>
          <?php endif;?>
            </ul>
      ...
      <form action="" id="MsgForm" name="MsgForm" method="post">
        <ul>
          ...
          <li class="yzm">
            ...
            <p class="message_yzmico"><img width="150" align="absmiddle" onclick="this.src='/cartshop/index.php/Home/Message/code/'+Math.random();" style="cursor:pointer;" title="看不清？点击一下！" alt="看不清？点击一下！" src="/cartshop/index.php/Home/Message/code" id="verify"></p>
