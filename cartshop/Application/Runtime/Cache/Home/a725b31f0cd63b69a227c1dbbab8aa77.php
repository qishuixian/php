  ...
  <div class="fyLeft">
      ...
      <div class="l_pro_t"><?php echo ($topname); ?></div>
        <ul class="l_procon">
          ...
          <?php foreach($son2 as $k=>$v): $cateid=$v['id']; if($contro){ $url="/cartshop/index.php/Home/carlist/index/cateid/$cateid"; }else{ $url="/cartshop/index.php/Home/Zplist/index/cateid/$cateid"; } ?>
          ...
          <li class="proOne"><a title="<?php echo $v['name'];?>" href="<?php echo $url;?>"><?php echo $v['name'];?></a>
            ...
            <li><a style="padding-left:50px;" title="<?php echo $v1['name'];?>" href="/cartshop/index.php/Home/Zplist/index/cateid/<?php echo $v1['id'];?>"><?php echo $v1['name'];?></a></li>
              <?php endforeach;?>
          <?php endif;?>
            </ul>
...
邮箱：<?php echo (C("EMAIL")); ?> </div>
  ...
  <div class="fyRight">
      <div class="title"> <span class="fl"><?php echo ($selftop); ?></span> <span class="fr">当前位置：<a href="/cartshop/index.php" title="首页">首页</a> > 
          ...
          <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><div class="hrBox">
      <div class="hrBoxL">
        <ul>
          <li><span>所需职位：</span></li>
          <li class="bgWhite">所需人数：</li>
          <li class="haode">具体要求：</li>
        </ul>
        <div class="clear"></div>
      </div>
      <div class="hrBoxR">
        <ul>
          <li class="topline"><span class="fl"><?php echo ($vo["title"]); ?></span><a title="应聘此职位" class="fr" href="/cartshop/index.php/Home/Job/index/arid/<?php echo ($vo["id"]); ?>"><img width="90" height="26" src="/cartshop/Public/pc/images/re.gif"></a>
            <div class="clear"></div>
          </li>
          <li class="bgWhite"><?php echo ($vo["num"]); ?><div class="clear"></div>
          </li>
          <li class="haode"><?php echo htmlspecialchars_decode($vo['des']);?></li>
        </ul>
        <div class="clear"></div>
      </div>
