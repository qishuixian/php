  ...
  <div class="fyLeft">
      ...
      <div class="l_pro_t"><?php echo ($topname); ?></div>
        <ul class="l_procon">
          ...
          <?php foreach($son2 as $k=>$v): $cateid=$v['id']; if($contro){ $url="/cartshop/index.php/Home/carlist/index/cateid/$cateid"; }else{ $url="/cartshop/index.php/Home/Job/index/cateid/$cateid"; } ?>
          ...
          <li class="proOne"><a title="<?php echo $v['name'];?>" href="<?php echo $url;?>"><?php echo $v['name'];?></a>
            ...
            <li><a style="padding-left:50px;" title="<?php echo $v1['name'];?>" href="/cartshop/index.php/Home/Job/index/cateid/<?php echo $v1['id'];?>"><?php echo $v1['name'];?></a></li>
              <?php endforeach;?>
          <?php endif;?>
            </ul>
      ...
      <div class="hrfra">
        ...
        <table width="95%" cellspacing="0" cellpadding="3" border="0" align="center" class="hr"> 
            ...
            <td height="25" align="left" class="bord" colspan="3">
               ...
               <img align="absmiddle" onclick="this.src='/cartshop/index.php/Home/Job/code/'+Math.random();" style="cursor:pointer;" title="看不清？点击一下！" alt="看不清？点击一下！" src="/cartshop/index.php/Home/Job/code" style="height:60px;" id="verify"> 
            </td>
            </tr>
        </tbody></table>
