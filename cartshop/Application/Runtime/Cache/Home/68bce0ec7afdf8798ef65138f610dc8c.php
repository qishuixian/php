    ...
    <div class="fyLeft">
      ...
      <div class="l_pro_t"><?php echo ($topname); ?></div>
        <ul class="l_procon">
          ...
          <?php foreach($son2 as $k=>$v): $cateid=$v['id']; if($contro){ $url="/cartshop/index.php/Home/carlist/index/cateid/$cateid"; }else{ $url="/cartshop/index.php/Home/Page/index/cateid/$cateid"; } ?>
          ...
          <li class="proOne"><a title="<?php echo $v['name'];?>" href="<?php echo $url;?>"><?php echo $v['name'];?></a>
            ...
            <li><a style="padding-left:50px;" title="<?php echo $v1['name'];?>" href="/cartshop/index.php/Home/Page/index/cateid/<?php echo $v1['id'];?>"><?php echo $v1['name'];?></a></li>
              <?php endforeach;?>
          <?php endif;?>
            </ul>
...
邮箱：<?php echo (C("EMAIL")); ?> </div>
    ...
    <div class="fyRight">
      <div class="title"> <span class="fl">
        <?php echo ($selftop); ?>       </span> <span class="fr">当前位置：<a href="/cartshop/index.php" title="首页">首页</a> > 
