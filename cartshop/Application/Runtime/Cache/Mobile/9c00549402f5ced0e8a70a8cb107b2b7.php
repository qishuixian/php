...
<div class="allpage">
 ...
 function getlist(page){
    $.ajax({
        type:"GET",
        url:"/cartshop/index.php/Mobile/Arlist/getlist/p/"+page+"/cateid/<?php echo I('get.cateid');?>",
        dataType:"json",
        success:function(data){
            ...
            $(data).each(function(k,v){
                html+='<li class="news1"><a  href="/cartshop/index.php/Mobile/Article/index/arid/'+v.id+'"><span>'+v.title+'</span><span>'+getLocalTime(v.time)+'</span></a></li>';
            });
