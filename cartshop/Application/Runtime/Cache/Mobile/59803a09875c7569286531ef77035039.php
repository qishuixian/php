...
<link rel="stylesheet" type="text/css" href="/cartshop/Public/mobile/style/master.css" />
  <link rel="stylesheet" type="text/css" href="/cartshop/Public/mobile/style/subpage.css" />
...
<link rel="stylesheet" type="text/css" href="/cartshop/Public/mobile/style/swiper.css" />
...
<script type="text/javascript" src="/cartshop/Public/mobile/style/nav.js"></script>
  ...
  <script type="text/javascript" src="/cartshop/Public/mobile/style/swiper.js"></script>
  <script type="text/javascript" src="/cartshop/Public/mobile/style/lihe.js"></script>
...
<div class="allpage">
  ...
  <!--header-->
  <div class="header">
    <div class="head"> <a href="/cartshop/index.php/mobile" title="盘古网络" class="logo">
     <img src="http://900523.ks.panguweb.cn/App/Cnm/Public/images/logo_03.png" alt="盘古网络"/> </a>
  ...
  <div class="content content_new">
      ...
      <div class="swiper-container">
        <div class="swiper-wrapper">
           <div class="swiper-slide">
                                        <img src="/cartshop/Public/mobile/images/E9B74D0114665E84D9580C171F6B7A83.jpg" />                    </div><div class="swiper-slide">
                                        <img src="/cartshop/Public/mobile/images/BAAE4C726F3E1A3E34ED76AC4AC4A8E9.jpg" />                    </div> 
    ...
    <div class="tubiao_i">
      <ul>
        <li> <a href="/cartshop/index.php/Mobile/page/index/cateid/88"><span class="iconfont02">&#xe614;</span><strong>关于我们</strong></a> </li><li> <a href="/cartshop/index.php/Mobile/page/index/cateid/89"><span class="iconfont02">&#xe7c7;</span><strong>如何租车</strong></a> </li><li> <a href="/cartshop/index.php/Mobile/page/index/cateid/90"><span class="iconfont02">&#xe628;</span><strong>如何还车</strong></a> </li><li> <a href="/cartshop/index.php/Mobile/arlist/index/cateid/91"><span class="iconfont02">&#xe61b;</span><strong>费用说明</strong></a> </li><li> <a href="/cartshop/index.php/Mobile/carlist/index/cateid/92"><span class="iconfont02">&#xe64b;</span><strong>优惠活动</strong></a> </li><li> <a href="/cartshop/index.php/Mobile/carlist/index/cateid/93"><span class="iconfont02">&#xe656;</span><strong>车辆展示</strong></a> </li><li> <a href="/cartshop/index.php/Mobile/arlist/index/cateid/94"><span class="iconfont02">&#xf00bc;</span><strong>车辆保养</strong></a> </li><li> <a href="/cartshop/index.php/Mobile/page/index/cateid/95"><span class="iconfont02">&#xe66f;</span><strong>联系我们</strong></a> </li>      
    ...
    <!---->
    <div class="ling_i">
     <a href=""><img src="/cartshop/Public/mobile/images/8A6B1622242744F4619AB05364247FE6.gif" alt=""></a> 
    ...
    <div class="lines"></div>
    <div class="lines lines01"></div>
    <div class="more_i"><span>车辆展示</span><a href="/cartshop/index.php/Mobile/carlist/index/cateid/93" title="更多">更多</a> </div>
    <div class="display_i">
      ...
      <div class="display_i02">
        <?php if(is_array($cares)): $i = 0; $__LIST__ = $cares;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><dl>
          <a href="/cartshop/index.php/Mobile/Article/index/arid/<?php echo ($vo["id"]); ?>">
          <dt><img src="/cartshop/<?php echo ($vo["pic"]); ?>" width="270" height="203"></dt>
          <dd>
    ...
    <div class="lines"></div>
    <div class="lines lines01"></div>
    <div class="more_i"><span>客户评价</span><a href="/cartshop/index.php/Mobile/message/index/cateid/97" title="更多">更多</a></div>
    <div class="pingj_i">
    <?php if(is_array($msgres)): $i = 0; $__LIST__ = $msgres;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><dl>
        <a href="/cartshop/index.php/Mobile/Message/index/cateid/97">
    ...
    <div class="lines"></div>
    <div class="lines lines01"></div>
    <div class="more_i"><span>优惠活动</span><a href="/cartshop/index.php/Mobile/carlist/index/cateid/92" title="更多">更多</a></div>
    <div class="case_c">
      <ul>
      <?php if(is_array($yhres)): $i = 0; $__LIST__ = $yhres;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><li><a href="/cartshop/index.php/Mobile/carlist/index/arid/<?php echo ($vo["id"]); ?>">
          <div class="case_c_pic"><img src="/cartshop/<?php echo ($vo["pic"]); ?>"></div>
    ...
    <div class="lines"></div>
    <div class="lines lines01"></div>
    <div class="more_i"><span>关于我们</span><a href="/cartshop/index.php/Mobile/page/index/cateid/88" title="更多">更多</a></div>
    ...
    <div class="lines"></div>
    <div class="lines lines01"></div>
    <div class="more_i"><span>车辆保养</span><a href="/cartshop/index.php/Mobile/arlist/index/cateid/94" title="更多">更多</a></div>
