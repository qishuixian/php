...
<script type="text/javascript" src="/cartshop/Public/mobile/style/nav.js"></script>
    ...
    <script type="text/javascript" src="/cartshop/Public/mobile/style/form.js"></script>
            ...
            <ul class="login">
              ...
              <input type="hidden" name="type" value="0" />
                ...
                <li>
                    ...
                    <img src="/cartshop/index.php/Mobile/Message/verify" class="login_pin" onclick="this.src='/cartshop/index.php/Mobile/Message/verify/'+Math.random();"  style="cursor:pointer;" />
                </li>
                <li>
