    ...
    <div class="content">
        <div class="about">
                <h1><?php echo ($arts["title"]); ?></h1>
                                <?php if($arts['pic'] != ''): ?><center><img src="/cartshop/<?php echo ($arts["pic"]); ?>" /></center><?php endif; ?>                <span class="picContent"><p><?php echo htmlspecialchars_decode($arts['content']);?></p>
</span>
                <a href="<?php echo ($furl); ?>" title="<?php echo ($fname); ?>" class="page">上一条：<?php echo ($fname); ?></a>                <a href="<?php echo ($aurl); ?>" title="<?php echo ($aname); ?>" class="page">下一条：<?php echo ($aname); ?></a>                <a href="/cartshop/index.php/Mobile/Article/index" title="返回列表" class="back">返回列表</a>        
        </div>
